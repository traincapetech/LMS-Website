...
import {
  FaUserTie, FaMicrosoft, FaAws, FaGoogle, FaProjectDiagram, FaApple, 
  FaCalculator, FaAutoprefixer, FaCertificate, FaChartLine, FaCogs, 
  FaHandsHelping, FaRocket, FaCode, FaCloud, FaBrain
} from "react-icons/fa";
...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-[#EDEDED] overflow-x-hidden font-sans selection:bg-primary/30">
      
      {/* --- Global Background Effects --- */}
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[#a67cff]/10 blur-[120px] rounded-full pointer-events-none z-0" />
      <div className="fixed bottom-0 right-0 w-[600px] h-[600px] bg-indigo-500/5 blur-[120px] rounded-full pointer-events-none z-0" />
      ...
      <div className="relative z-10">
        ...
        {/* 2. CAREER ACCELERATOR SECTION (Simplified & Spaced) */}
        ...
        {/* ---------- Moved: Pricing, Testimonials, AI, Trending OUTSIDE goals-section ---------- */}
